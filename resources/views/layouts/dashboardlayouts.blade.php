      ...
      <nav class="sidebar-nav">
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="Categorys" class="collapse dropdown-nav">
              <li>
                <a href="{{route('Category.Addview')}}">Add Catagory </a>
              </li>
              <li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="posts" class="collapse dropdown-nav">
              <li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="Burgers" class="collapse dropdown-nav">
              <li>
                <a href="{{route('BurgerItem.Add')}}">Burger Add </a>
              </li>
              <li>
                <a href="{{route('BurgerItem.store')}}"> ViewAdd Burger</a>
              </li>
              <li>
                <a href="{{route('Burger.All')}}">All Burger </a>
              </li>
            </ul>
            ...
            <li class="nav-item nav-item-has-children">
              ...
              >
                ...
                <span class="text">Juico</span>
              </a>
              <ul id="Juicos" class="collapse dropdown-nav">
                <li>
                  <a href="{{route('JuicoItem.Add')}}">Juico Add </a>
                </li>
                
                <li>
                  <a href="{{route('Juico.All')}}">All Juico </a>
                </li>
              </ul>
            ...
            <li class="nav-item nav-item-has-children">
              ...
              <ul id="restaturants" class="collapse dropdown-nav">
                <li>
                  <a href="{{route('Restaturant.Add')}}">Restaurant Add </a>
                </li>
                <li>
                  <a href="{{route('Restaturant.Add.all')}}">All Restaurant </a>
                </li>
              </ul>
            ...
            <li class="nav-item nav-item-has-children">
              ...
              >
                ...
                <span class="text">Special Dish</span>
              </a>
              <ul id="SpecialDishs" class="collapse dropdown-nav">
                <li>
                  <a href="{{route('SpecialDish.Add')}}">Special Dish Add </a>
                </li>
                <li>
                  <a href="{{route('SpecialDish.Add.All')}}">All Special Dish </a>
                </li>
              </ul>
              ...
              >
                ...
                <span class="text">Food Plat</span>
              </a>
              <ul id="foodplats" class="collapse dropdown-nav">
                <li>
                  <a href="{{route('Foodplat.Add')}}">Food Plat Add </a>
                </li>
                <li>
                  <a href="{{route('Foodplat.All')}}">All Food Plat </a>
                </li>
              </ul>
...
{{-- 
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="posts" class="collapse dropdown-nav">
                ...
                <a href="{{route('SubCategory.Addview')}}">AddSubCategory</a>
              </li>

              <li>
                <a href="{{route('SubCategory.view')}}">Sub Category</a>
              </li>
